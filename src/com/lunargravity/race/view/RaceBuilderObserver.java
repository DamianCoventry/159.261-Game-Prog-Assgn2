...
public class RaceBuilderObserver implements ISceneBuilderObserver {
    ...
    public RaceBuilderObserver(IEngine engine, IManualFrameUpdater manualFrameUpdater) throws IOException {
    ...
    private Widget createBackgroundImageWidget() throws IOException {
        ...
        wci._properties.put(ImageWidget.BACKGROUND_IMAGE, "images/LoadingRace.png");
