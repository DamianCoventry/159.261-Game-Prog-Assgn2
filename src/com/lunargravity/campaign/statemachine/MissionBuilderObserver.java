...
public class MissionBuilderObserver implements ISceneBuilderObserver {
    ...
    public MissionBuilderObserver(IEngine engine, IManualFrameUpdater manualFrameUpdater) throws IOException {
    ...
    private Widget createBackgroundImageWidget() throws IOException {
        ...
        wci._properties.put(ImageWidget.BACKGROUND_IMAGE, "images/LoadingCampaignMission.png");
